"main";let postcss;_144‍.w('postcss',[["default",function(v){postcss=v}]]);let valueParser;_144‍.w('postcss-value-parser',[["default",function(v){valueParser=v}]]);let flatMap;_144‍.w('lodash',[["flatMap",function(v){flatMap=v}]]);
...
_144‍.d(postcss.plugin('postcss-font-family-system-ui', () => {
  return (root) => {
    root.walk(transform())
  }
}));
